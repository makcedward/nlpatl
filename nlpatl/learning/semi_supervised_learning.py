...
class SemiSupervisedLearning(Learning):
    ...
    def __init__(
        ...
        self.most_confidence_sampling = MostConfidenceSampling(
            threshold=self_learn_threshold
        ).sample
    ...
    def get_self_learn_data(self):
        ...
        return (
            self.self_learn_indices,
            self.self_learn_x,
            self.self_learn_x_features,
            self.self_learn_y,
        )

    def learn(
        self,
        x: Union[List[str], List[int], List[float], np.ndarray] = None,
        y: Union[List[str], List[int]] = None,
