...
latex_documents = [
    (master_doc, 'nlpatl.tex', 'nlpatl Documentation',
     'Edward Ma', 'manual'),
]
...
man_pages = [
    (master_doc, 'nlpatl', 'nlpatl Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'nlpatl', 'nlpatl Documentation',
     author, 'nlpatl', 'Active Learning for NLP',
     'Miscellaneous'),
]
