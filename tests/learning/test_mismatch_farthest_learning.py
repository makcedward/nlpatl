...
from nlpatl.models.clustering import SkLearnClustering, SkLearnExtraClustering
...
class TestLearningMismatchFarthest(unittest.TestCase):
    ...
    def test_explore_second_stage(self):
        ...
        for learning in [sklearn_extra_clustering_learning, self.learning]:
            ...
            learning.learn_x_features = [
                self.train_features[idx] for idx in learn_indices
            ]
