...
class TestSamplingNearest(unittest.TestCase):
	...
	def setUpClass(cls):
		cls.data = np.array([
			1.75512648, 2.4474237 , 2.72141409, 2.38541532, 2.32101798,
			2.29712701, 1.84427822, 1.88990271, 2.42033386, 2.6152091 ,
			2.6152091 , 2.75662065, 3.37551308, 2.52874994, 2.53957653
		])
		cls.groups = np.array(
